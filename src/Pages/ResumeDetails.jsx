...
export default function ResumeDetails() {
  ...
  const inputStyle =
    "bg-zinc-800 text-white border border-zinc-600 px-3 py-2 rounded w-full";
      ...
      <div className="max-w-7xl mx-auto bg-black border-1 border-white p-6 rounded-lg shadow">
        ...
        <section className="mb-6">
            ...
            <div className="space-x-4">
              ...
              >
                {isEditing.education ? (
                  ...
                  <img src={edit} width={30} height={30} alt="Edit Icon" />
                )}
              </button>
            </div>
          </div>
          {resume.education?.map((ed, index) => (
            <div
              key={index}
              className="mb-4 p-4 bg-black border-1 border-white rounded"
            >
              ...
              {isEditing.education && (
                ...
                >
                  {ed._isNew ? (
                    <img src={bin} width={30} height={30} alt="delete Icon" />
                  ) : (
                    "Cancel"
                  )}
                </button>
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    value={proj.tech}
                    onChange={(e) =>
                      handleChange("projects", index, "tech", e.target.value)
                    }
                    readOnly={!isEditing.projects}
                    className={inputStyle}
                  />
              ...
              {isEditing.projects && (
                <button
                  ...
                  className={`mt-2 text-sm underline ${
                    proj._isNew ? "text-orange-400" : "text-red-400"
                  }`}
                >
                  {proj._isNew ? (
                    <img src={bin} width={30} height={30} alt="delete Icon" />
        ...
        <section className="mb-6">
          <div className="flex justify-between items-center mb-2">
            ...
            <div className="space-x-4">
              ...
              <button
                onClick={() => handleEditToggle("achievements")}
                className="text-blue-600 underline"
              >
          ...
          {resume.achievements?.map((achievement, index) => (
            ...
            >
              ...
              <input
                ...
                onChange={(e) =>
                  handleChange("achievements", index, "name", e.target.value)
                }
                className={inputStyle}
        ...
        <section className="mb-6">
          <div className="flex justify-between items-center mb-2">
            ...
            <div className="space-x-4">
              ...
              <button
                onClick={() => handleEditToggle("languages")}
                className="text-blue-600 underline"
              >
                {isEditing.languages ? (
                  "Stop Editing"
          ...
          {resume.languages?.map((language, index) => (
            ...
            >
              ...
              <input
                value={language.name}
                onChange={(e) =>
                  handleChange("languages", index, "name", e.target.value)
                }
                className={inputStyle}
        ...
        <section className="mb-6">
          <div className="flex justify-between items-center mb-2">
            ...
            <div className="space-x-4">
              ...
              <button
                onClick={() => handleEditToggle("referral")}
                className="text-blue-600 underline"
              >
                {isEditing.referral ? (
                  "Stop Editing"
          ...
          {resume.referral?.map((referral, index) => (
            ...
            >
              ...
              <input
                value={referral.name}
                onChange={(e) =>
                  handleChange("referral", index, "name", e.target.value)
                }
                className={inputStyle}
        ...
        <button
          className="ml-80 bg-white text-black font-bold px-3 py-2 rounded w-xl hover:bg-gray-200 transition duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
          onClick={handleSave}
        >
          Save Changes
        </button>
